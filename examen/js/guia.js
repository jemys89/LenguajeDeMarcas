...
function gestionarXml(dadesXml){
 ...
 var opcionesSelect = [];
 var nopt = xmlDoc.getElementById("jdos_002").getElementsByTagName('option').length;
  for (i = 0; i < nopt; i++) { 
    opcionesSelect[i] = xmlDoc.getElementById("jdos_002").getElementsByTagName('option')[i].innerHTML;
 }
 ...
 var nopt = xmlDoc.getElementById("jdos_003").getElementsByTagName('option').length;
 for (i = 0; i < nopt; i++) { 
...
>>>>>>> 3f45428ac70c7052c1476f4e60ed5495d869f3cf
}